...
(
                    ...
                    + "-"
                    if (len(x) - i) == 2 or ((len(x) - i) - 2) % 3 == 0 and x[i] != "0"
                    else (
                        {
                            "0": "ten",
                            "1": "eleven",
